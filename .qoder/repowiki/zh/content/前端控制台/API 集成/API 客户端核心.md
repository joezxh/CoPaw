...
- 错误消息不清晰
  ...
  - 参考实现位置：[request.ts:84-93](file://console/src/api/request.ts#L84-L93)，[error.ts:1-12](file://console/src/utils/error.ts#L1-L12)
- Content-Type 问题
...
- 上传失败
  ...
  - 参考实现位置：[auth.ts:15-49](file://console/src/api/modules/auth.ts#L15-L49)
...
- 使用 request 对象发起请求
  ...
  - POST：参考 [auth.ts:16-26](file://console/src/api/modules/auth.ts#L16-L26)
  - PUT/DELETE/PATCH：参考 [auth.ts:51-74](file://console/src/api/modules/auth.ts#L51-L74)
- 登录/注册/状态检查
  - 参考 [auth.ts:15-49](file://console/src/api/modules/auth.ts#L15-L49)
- 解析结构化错误
  - 参考 [error.ts:1-12](file://console/src/utils/error.ts#L1-L12)
- 最佳实践
